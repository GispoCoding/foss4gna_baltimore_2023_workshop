...
If you decide to use Aiven for your workshop and would like to take advantage of free bonus credits for a more powerful PostgreSQL database, please provide your email address through the following Google Forms link. This will ensure you receive the bonus credits to enhance your database experience.
...
By following these guidelines, you will be able to leverage the capabilities of a remote PostgreSQL database provided by Aiven, empowering you to work with a more robust and scalable infrastructure for your workshop.Creating a Spatial Database
...
![Now you can see connection and explore the database:](img/p1/p_01_i_02.png)

...
Using a localhost setup for the workshop, the database connection details would look for example as follows: ![](img/p1/add_postgres.png)
...
![](img/p1/change_db.gif)

#### Finally: adding PostGIS to the database

...
CREATE TABLE dwellings (
    ...
    dwelling_id SERIAL PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE water_distribution_points (
    ...
    point_id SERIAL PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE educational_facilities (
    ...
    facility_id SERIAL PRIMARY KEY GENERATED ALWAYS AS IDENTITY,
